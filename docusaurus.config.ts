...
const config: Config = {
  ...
  url: 'https://yzqzy.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  // Use '/' for local development, '/wechat-assistant-pro-docs/' for production
  baseUrl:
    process.env.NODE_ENV === 'production' ? '/wechat-assistant-pro-docs/' : '/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'yzqzy', // Usually your GitHub org/user name.
